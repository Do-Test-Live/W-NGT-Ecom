                        ...
                        <div class="card-body">
                            <div class="media align-items-center">
                                ...
                                <div class="d-inline-block position-relative donut-chart-sale">
                                    <span class="donut1"
                                          data-peity='{ "fill": ["rgb(255, 255, 255)", "rgba(255, 255, 255, 0)"],   "innerRadius": 41, "radius": 10}'>6/8</span>
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-sm-6 mb-sm-0 mb-3 text-center">
                                            ...
                                            <p class="fs-14">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                                                sed do </p>
                                            <a href="post-details.html" class="btn btn-primary light btn-rounded">More
                                                Details</a>
                                        </div>
                                    </div>
                                    <div class="row">
                    ...
                    <div class="card">
                        <div class="card-header d-sm-flex d-block pb-0 border-0">
                            ...
                            <div class="dropdown mt-sm-0 mt-3">
                                <button type="button" class="btn btn-primary light btn-rounded dropdown-toggle"
                            ...
                            <div class="d-flex flex-wrap mb-4">
                                <div class="mr-auto mb-2 pr-3 d-flex align-items-center">
                                    <svg width="25" height="26" viewBox="0 0 25 26" fill="none"
                                        ...
                                        <rect x="7.09088" y="7.09082" width="3.54545" height="18.9091" rx="1.77273"
                                              fill="#EA7A9A"/>
                                        <rect x="14.1819" y="17.7271" width="3.54545" height="8.27273" rx="1.77273"
                                              fill="#EA7A9A"/>
                                        <rect x="21.2727" y="3.54541" width="3.54545" height="22.4545" rx="1.77273"
                                              fill="#EA7A9A"/>
                                    </svg>
                                    <div class="ml-3">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 mb-sm-0 mb-3">
                                            <div class="media align-items-center">
                                                <div class="d-inline-block mr-3 position-relative donut-chart-sale2">
                                                    <span class="donut2"
                                                          data-peity='{ "fill": ["rgb(84, 205, 81)", "rgba(255, 255, 255, 1)"],   "innerRadius": 27, "radius": 10}'>6/8</span>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="media align-items-center">
                                                <div class="d-inline-block mr-3 position-relative donut-chart-sale2">
                                                    <span class="donut2"
                                                          data-peity='{ "fill": ["rgb(255, 55, 112)", "rgba(255, 255, 255, 1)"],   "innerRadius": 27, "radius": 10}'>3/8</span>
                                                    <small class="text-black">
                                                        14%
                                                    </small>
                                                </div>
                            ...
                            <div class="card trending-menus">
                                ...
                                <div class="card-body">
                                    <div class="d-flex pb-3 mb-3 border-bottom tr-row align-items-center">
                                        ...
                                        <div class="mr-auto pr-3">
                                            <a href="post-details.html"><h2 class="text-black fs-14">Medium Spicy
                                                Spagethi Italiano</h2></a>
                                            <span class="text-black font-w600 d-inline-block mr-3">$5.6 </span> <span
                                    ...
                                    <div class="d-flex pb-3 mb-3 border-bottom tr-row align-items-center">
                                        ...
                                        <div class="mr-auto pr-3">
                                            <a href="post-details.html"><h2 class="text-black fs-14">Watermelon juice
                                                with ice</h2></a>
                                            <span class="text-black font-w600 d-inline-block mr-3">$5.6 </span> <span
                                                class="fs-14">Order 89x</span>
                                        </div>
                                    ...
                                    <div class="d-flex pb-3 mb-3 border-bottom tr-row align-items-center">
                                        ...
                                        <div class="mr-auto pr-3">
                                            <a href="post-details.html"><h2 class="text-black fs-14">Chicken curry
                                                special with cucumber</h2></a>
                                            <span class="text-black font-w600 d-inline-block mr-3">$5.6 </span> <span
                                                class="fs-14">Order 89x</span>
                                        </div>
                                    ...
                                    <div class="d-flex pb-3 mb-3 border-bottom tr-row align-items-center">
                                        ...
                                        <div class="mr-auto pr-3">
                                            <a href="post-details.html"><h2 class="text-black fs-14">Italiano Pizza With
                                                Garlic</h2></a>
                                            <span class="text-black font-w600 d-inline-block mr-3">$5.6 </span> <span
                                                class="fs-14">Order 89x</span>
                                        </div>
                                    ...
                                    <div class="d-flex tr-row align-items-center">
                                        ...
                                        <div class="mr-auto pr-3">
                                            <a href="post-details.html"><h2 class="text-black fs-14">Tuna Soup spinach
                                                with himalaya salt</h2></a>
                                            <span class="text-black font-w600 d-inline-block mr-3">$5.6 </span> <span
                                                class="fs-14">Order 89x</span>
                                        </div>
                                        <img src="images/menus/9.png" alt="" width="60" class="rounded">
